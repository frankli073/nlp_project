...
### 6. Final Model of Choice
- The final models developed are based on below two methodologies:
1. LSTM (for Text Generation) + LSTM (for Rhyming Word in Output)
2. MArkov Models (for Text Generation) + LSTM (for Rhyming Word in Output)
